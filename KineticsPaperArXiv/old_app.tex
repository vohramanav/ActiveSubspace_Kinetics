...
value in the input domain. The nominal values of the rate parameters, 
$A_i$'s and $E_{a,i}$'s were taken from~\cite{Yetter:1991}. 
The nominal values of $P_0$, $T_0$, and
=======
...
>>>>>>> 79437e00351d6e664fe61cfc51f2be8499f92a82
