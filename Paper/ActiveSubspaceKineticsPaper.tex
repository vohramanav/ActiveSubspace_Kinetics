...
\[
   \sum_{k=r+1}^\Np \lambda_k \ip{\vec{e}_j}{\vec{u}_k}^2 \leq \lambda_{r+1} \sum_{k=r+1}^\Np \ip{\vec{e}_j}{\vec{u}_k}^2
   \leq \lambda_{r+1}. 
\]
The last inequality holds because 
$1 = \norm{\vec{e}_j}^2 = \sum_{k = 1}^\Np \ip{\vec{e}_j}{\vec{u}_k}^2 \geq \sum_{k=r+1}^\Np \ip{\vec{e}_j}{\vec{u}_k}^2$.
\end{proof} 
