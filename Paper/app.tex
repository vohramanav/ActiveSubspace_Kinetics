...
strategy yields consistent results for the $A_i$'s, but it does not capture the sensitivity associated with one of the most important parameters, $E_{a,15}$. This is because numerical errors are incurred when approximating
