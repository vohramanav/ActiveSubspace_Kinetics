...
active subspace. The modal estimate from either PDF is found to be in agreement with that
based on the histogram plot. Moreover, the spread in the ignition
delay is reasonably captured by the PDFs. 

Based on these observations, it can be said that a 1-dimensional surrogate can be used to reasonably approximate the
uncertainty in the ignition delay due to uncertain rate-controlling parameters used in the H$_2$/O$_2$ reaction
mechanism. 
