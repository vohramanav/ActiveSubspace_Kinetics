...
Components of the dominant eigenvector in Figure~\ref{fig:conv_app} (left) are utilized for estimating the
...
%
\be
\varepsilon_d = \frac{\|f(\bm{\theta}) - \mathcal{Y}(\bm{\xi})\|}{\|f(\bm{\theta})\|}
\ee
%
