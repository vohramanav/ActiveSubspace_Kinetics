...
can be mapped to a corresponding component of $\bm{\xi}$ in $\Omega\in\mathbb{R}^{N_p}$
($N_p$: number of uncertain inputs)
using a linear transformation.  Hence, from this point onwards, we denote $f$ as $f(\bm{\xi})$.
