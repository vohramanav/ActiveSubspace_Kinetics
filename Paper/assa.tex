...
where $N_p$ is number of uncertain inputs.
In practical computations, the \emph{canonical} variables $\xi_i$ are  
...
\begin{enumerate}
\item Consider a set of input-output pairs, $\{\vec{\xi}_i, f(\vec{\xi}_i)\}$, $i = 1, \ldots, N$.
