...
(\alennote{Any references for this?})
...
challenging due to increase in computational effort.~\alennote{I don't see why
these references are being cited here. Are these cited as examples of efforts
in calibrating chemical systems?} 

In this paper, we focus on mitigating the computational challenge
...
energy for locomotive applications~\cite{Das:1996}. (\alennote{you say recent years, but
the reference is from 1996, are there more recent papers you can refer to?}.   
