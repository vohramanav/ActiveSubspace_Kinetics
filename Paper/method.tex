...
earlier in~\ref{sub:grad} is found to be smaller than $\tau$. An outline of the gradient-free approach is
...
%\renewcommand{\algorithmicensure}{\textbf{Output:}}
  ...
  \begin{algorithmic}[1]
	...
	\[
	\begin{aligned}
	\Phi_i &= \{ p \text{ nearest points in } \{\bm{\xi}_j\}_{j=1}^{N} \text{ to } \bm{\nu}_i\}\\
	\vspace{-2mm}
