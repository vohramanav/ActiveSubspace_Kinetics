...
As discussed earlier, gradient estimation using finite differences in the 
...
in~\cite{Constantine:2015}. Hence, the computational effort is  
...
As mentioned earlier, the model output $f(\bm{\xi})$ i.e. the igntion delay in the
