...
$\hat{\mat{W}}_1$ and a diagonal matrix, 
$\hat{\mat{\Lambda}}_1$ that comprises the eigenvalues along the diagonal.
...
the activity scores for individual uncertain parameters ($\nu_{i,r}$; $r$=1 since the
