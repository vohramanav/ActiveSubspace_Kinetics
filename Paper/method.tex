...
%In  Figure~\ref{fig:eig_comp} (right), the relative L-2 error norm for the
%first five eigenvectors is plotted. 
...
gradients in this case. In the following section, we will once again use both
approaches to discover an active subspace in the high-dimensional 
problem involving 33 uncertain inputs. 
