...
are found to be in close agreement. Hence, although the relative L$^2$ norm of the discrepancy~($\varepsilon_d$)
is found to be considerably large, the uncertainty in the ignition delay is captured by both 
approaches with reasonable accuracy. 
