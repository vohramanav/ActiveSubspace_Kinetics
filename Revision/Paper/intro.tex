...
Singular Perturbation (CSP)~\cite{GoussisLam92,FotacheKreutzLaw97,
Lam85,LamGoussis89,ValoraniCretaGoussisEtAl06,
DebusschereMarzoukNajmEtAl12,
SalloumAlexanderianLeMaitreEtAl12,
GuptaImValorani13} that aim to reduce the
...
the perturbation approach. On the other hand, the second approach 
follows from~\cite{Constantine:2015} and involves repeated
linear regression-fits to a subset of available model evaluations, and is 
