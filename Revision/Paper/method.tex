...
Figure~\ref{fig:comp} (right) to illustrate convergence characteristics of Algorithm~\ref{alg:grad} \rebut{in both cases}. 
%
\begin{figure}[htbp]
 \begin{center}
...
\end{figure}
%
\rebut{Convergence was established once $\max(\delta \hat{\mat{W}}_{1,j}^{(r)})$ was found
to be smaller than a set tolerance, $\tau$ = 0.05. As shown in Figure~\ref{fig:comp}, 8
iterations were required in both cases. To compare convergence characteristics or the
}
