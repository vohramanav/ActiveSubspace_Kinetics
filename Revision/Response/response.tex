...
As suggested by the reviewer, we have focused on a quantitative comparison in terms of the
...
The reviewer has made a valuable suggestion. Therefore, in the revised manuscript, we have
...
The title has been updated as ``Active subspace-based dimension reduction for chemical kinetics
...
In the revised manuscript, we denote $n_i$ as the `temperature exponent' as suggested by
...
The ignition delay is considered as the time required for the rate of temperature increase to
...
We could not locate the number 33 in the location specified by the reviewer. Nevertheless, we would like
...
The equation as well as the following descritption of the expectation and the variance
