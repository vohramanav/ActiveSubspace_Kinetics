...
\title[Dimension Reduction: Chemical Kinetics]{\textbf{Efficient UQ for Chemical Systems
...
\begin{column}{0.5\textwidth}
 \begin{center}
  \includegraphics[width=0.80\textwidth]{./Figures/comp_eig}
\end{center}
\end{column}
\begin{column}{0.5\textwidth}
 \begin{center}
  \includegraphics[width=0.8\textwidth]{./Figures/comp_eigv}
\end{center}
\end{column}
\end{columns}
