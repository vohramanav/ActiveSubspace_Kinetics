...
\subsection{ac}
\begin{frame}{Gradient-free Approach} 
...
\myitem Uniform Priors:  \scriptsize $A_i\in[0.9A_i^\ast, 1.1A_i^\ast]$, $E_{a,i}\in[0.99E_{a,i}^\ast, 1.01E_{a,i}^\ast]$
\vspace{1mm}
\normalsize
...
\begin{frame}{Convergence: Eigenvectors} 
 ...
 \begin{center}
  \includegraphics[width=0.65\textwidth]{./Figures/err_eigv_1_5}
\end{center}
...
\begin{columns}
\begin{column}{0.5\textwidth}
Relative L-2 error norm:\\
\scriptsize
\begin{align}
\varepsilon &= \frac{\|G(\bm{\theta})^2 - Y(\bm{\xi})^2\|}{\|G(\bm{\theta})^2\|} \nonumber \\ 
&= 8.92\times10^{-2} \nonumber
\end{align}
...
\begin{center}
\begin{figure}[htbp]
\includegraphics[width=1.0\textwidth]{./Figures/pdf_comp_id_1e4}
\end{figure}
\end{center}
